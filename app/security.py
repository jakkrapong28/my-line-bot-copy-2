...
def verify_jwt(authorization: str | None = Header(None)) -> bool:
    ...
    try:
        ...
        raise HTTPException(401, "Token หมดอายุ กรุณา Login ใหม่") from None
    except jwt.PyJWTError:
        raise HTTPException(403, "Invalid Token") from None
